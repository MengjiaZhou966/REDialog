    ...
    def get_train_batch(self):
        ...
        for b in range(self.train_batches):
            ...
            for i, index in enumerate(cur_batch):
                ...
                # context_s_starts[i].copy_(torch.from_numpy(self.data_train_bert_s_starts[index, :]))
    ...
    def get_test_batch(self):
        ...
        for b in range(self.test_batches):
            ...
            for i, index in enumerate(cur_batch):
                ...
                # context_s_starts[i].copy_(torch.from_numpy(self.data_test_bert_s_starts[index, :]))
